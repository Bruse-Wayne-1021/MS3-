            ...
            modelBuilder.Entity("MS3_LMS.Enity.Book.Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GenreId = new Guid("73c33982-8d42-4baa-bfed-8093f5870435"),
                            BookGenre = "Fiction",
                            Description = "Fictional stories"
                        },
                        new
                        {
                            GenreId = new Guid("589ccfd9-7e1f-479c-9fc5-b84c5edf9f56"),
                            BookGenre = "Non Fiction",
                            Description = "Non-fictional content"
                        },
                        new
                        {
                            GenreId = new Guid("971ee420-8808-4e02-ab50-b1c14e837d3a"),
                            BookGenre = "Science Fiction",
                            Description = "Sci-fi stories"
                        },
                        new
                        {
                            GenreId = new Guid("72f4dfb1-475e-421e-b21b-9e9cd03cc3e3"),
                            BookGenre = "Mystery",
                            Description = "Mystery novels"
                        },
                        new
                        {
                            GenreId = new Guid("636d888a-d2e6-4801-bd88-4f88754dd65c"),
                            BookGenre = "Thriller",
                            Description = "Thrilling stories"
                        },
                        new
                        {
                            GenreId = new Guid("e19f8280-a2ef-45ac-99bb-81943f936efe"),
                            BookGenre = "Romance Novel",
                            Description = "Romantic tales"
                        },
                        new
                        {
                            GenreId = new Guid("f04d0acb-af5b-4e47-bea8-68da334417f0"),
                            BookGenre = "Biography",
                            Description = "Life stories of individuals"
                        },
                        new
                        {
                            GenreId = new Guid("dbc5b430-64b5-49c0-806e-dc07dfe2cb25"),
                            BookGenre = "Humor",
                            Description = "Funny and comedic stories"
                        },
                        new
                        {
                            GenreId = new Guid("ce5b59a8-72b8-4a33-b64a-2cce6d006ea0"),
                            BookGenre = "Fairy Tale",
                            Description = "Fairy tales and folklore"
                        },
                        new
                        {
                            GenreId = new Guid("3d22f4bd-3d93-4ebc-a1e9-8342da5ecb03"),
                            BookGenre = "Graphic Novel",
                            Description = "Stories told through illustrations"
                        },
                        new
                        {
                            GenreId = new Guid("923cc9eb-2c12-443e-a6db-4fe113f490ed"),
                            BookGenre = "True Crime",
                            Description = "Real-life crime stories"
                        },
                        new
                        {
                            GenreId = new Guid("64a420ad-d3bf-444f-9fe0-283ef5b68505"),
            ...
            modelBuilder.Entity("MS3_LMS.Enity.Book.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LanguageId = new Guid("10d2999f-a455-425f-b987-067f12849f84"),
                            TypeOfLanguage = "English"
                        },
                        new
                        {
                            LanguageId = new Guid("eeaea7a9-1e43-4f28-bb7e-baf1742bd462"),
                            TypeOfLanguage = "Tamil"
                        },
                        new
                        {
                            LanguageId = new Guid("f6f04e37-f057-4aaa-8bdf-63f635912c67"),
            ...
            modelBuilder.Entity("MS3_LMS.Enity.User.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleID = new Guid("fc1b3553-871d-49b8-b27b-88b16bc35dc7"),
                            UserAType = "Member"
                        },
                        new
                        {
                            RoleID = new Guid("f3ed2191-e840-46a3-9489-3a131094c743"),
                            UserAType = "Admin"
                        });
                });
