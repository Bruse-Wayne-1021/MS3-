...
namespace MS3_LMS.Migrations
{
    ...
    [Migration("20241114063022_fkpijoj")]
    partial class fkpijoj
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MS3_LMS.Enity.User.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleID = new Guid("5e3e5d3e-5966-4913-9a48-d90cb281fd3f"),
                            UserAType = "Member"
                        },
                        new
                        {
                            RoleID = new Guid("78fa6f2a-2b98-4d90-b0df-b91bcd1f3069"),
                            UserAType = "Admin"
                        });
                });
